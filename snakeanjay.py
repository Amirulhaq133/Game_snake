...
class Game:
    def __init__(self):
        ...
        self.apple1 = Apple(self.frame_size_x, self.frame_size_y)
        self.apple2 = Apple(self.frame_size_x, self.frame_size_y)
        self.score = 0
    
    def game_over(self):
        my_font = pygame.font.SysFont('Arial', 90)
        game_over_surface = my_font.render('MISSION FAILED', True, pygame.Color(255, 0, 0))
